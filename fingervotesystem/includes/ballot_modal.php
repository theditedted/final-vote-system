    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="preview_modal_label">Preview Ballot</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="preview_body">
                <!-- Preview Ballot Content Goes Here -->
            </div>
            <div class="modal-footer">
                <!-- Move Submit Button Here -->
                <button type="button" class="btn btn-primary btn-flat" id="submit_preview"><i class="fa fa-check-square-o"></i> Submit</button>
